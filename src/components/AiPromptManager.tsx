...
const DEFAULT_PROMPTS: Omit<AiPromptConfig, 'currentPrompt'>[] = [
  ...
  { id: 'competitor_listing', name: '竞品·Listing 解析', description: '站在买家视角对比多个竞品详情页（标题/主图/价格/五点等）',
  ...
  { id: 'competitor_traffic', name: '竞品·流量解析', description: '对比流量结构、流量占比、ABA、自然/广告排名与广告依赖',
  ...
  { id: 'competitor_matrix', name: '竞品·产品矩阵解析', description: '解读父体变体结构与同品牌其他链接（大盘数据）',
